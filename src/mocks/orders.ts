...
export const seedOrders: Order[] = [
  ...
  },
  {
    ...
    rawRemark: '請週五出貨，客人僅周六可收。帝王芭樂請給10顆裝', cleanRemark: '僅週五出貨、週六收；本單請出 10 顆裝',
    judgeStatus: 'AI判定完成', shipStatus: '可出貨',
  ...
  },
  {
    ...
    rawRemark: '過兩天要出國6/6才回國，最快6/6可收貨，再麻煩晚一點寄出', cleanRemark: '客人 6/6 才可收貨，請晚一點寄',
    judgeStatus: 'AI判定完成', shipStatus: '可出貨',
  ...
  },
  {
    ...
    productName: '玉荷包荔枝', variety: '玉荷包荔枝', spec: '1盒(5斤裝)', qty: 1, tempLayer: '冷藏',
    rawRemark: '出貨窗口已過，農友尚未出貨', cleanRemark: '請盡快出貨',
  ...
  // ── 農友 2：蔣蔣果園 ──
  {
    ...
    productName: '玉荷包荔枝', variety: '玉荷包荔枝', spec: '1盒(3斤裝)', qty: 1, tempLayer: '冷藏',
    rawRemark: '收件人改成公司地址，麻煩重寄', cleanRemark: '（地址已更新）',
    judgeStatus: 'AI判定完成', shipStatus: '改單待重印',
  ...
  // ── 農友 4：冬陽芒果農場 ──
  {
    ...
    productName: '夏雪芒果', variety: '夏雪芒果', spec: '1盒(精品大果)', qty: 1, tempLayer: '冷藏',
    rawRemark: '6/20-6/22 出國不在家', cleanRemark: '6/20–6/22 不可收貨',
    judgeStatus: 'AI判定完成', shipStatus: '可出貨',
  ...
  },
  {
    ...
    rawRemark: '週五寄，週六我在家', cleanRemark: '僅週五出貨、週六收',
    judgeStatus: 'AI判定完成', shipStatus: '改單待重印',
  ...
  },
  {
    ...
    rawRemark: '6/13、6/16 兩天有事沒辦法收，其他照舊', cleanRemark: '6/13、6/16 不可收貨',
    judgeStatus: 'AI判定完成', shipStatus: '可出貨',
